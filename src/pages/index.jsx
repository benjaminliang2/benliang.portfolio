      ...
      <main className=" bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40">
        ...
        <section className="py-5 max-w-xl mx-auto md:text-xl">
          ...
          <div className="flex flex-col gap-10 py-10  lg:flex-wrap">
            ...
            <div className="bg-teal-50 rounded-lg">
              ...
              <p className="text-base">Nutrition Tracker is a mobile application that allows users to log their daily nutritional intake.
                I developed it with React Native and AWS serverless architecture. Users can currently authenticate themselves and save their data with AWS Cognito and AWS DynamoDB.
                I plan on implementing a third party APIs so the application can pre-fill nutritional facts based on the food item.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-5 max-w-xl mx-auto md:text-xl">
          ...
          <div className="flex flex-col gap-3 pl-10 lg:flex-wrap">
            ...
            <p className="text-base">Bachelor of Science, Mechanical Engineering</p>
          </div>
          ...
          <div className="flex flex-col gap-3 pl-10 lg:flex-wrap">
            ...
            <p className="text-base">COMPSCI X404.1 Data Structures and Algorithms, UC Berkeley Extension</p>
            <p className="text-base">Google IT Automation with Python, Coursera</p>
            <p className="text-base">Data Science and Machine Learning Bootcamp, Udemy </p>
